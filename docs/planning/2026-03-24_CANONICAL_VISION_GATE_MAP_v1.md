...
Current active gate: **Gate 66 in the V6 successor pack**. Gates 59–65 are complete on `main`; the attached `_v4_5` salvage pair is archived under `docs/legacy/` and is not active authority.
...
8. Gates 46–50 are complete on `main`; Gates 51–55 are complete on `main`; Gates 56–58 are complete on `main`; Gates 59–65 are complete on `main`; Gate 66 is the next active gate in the V6 successor pack.
