...
Current active gate: **Gate 78 in the V6 successor pack**. Gates 59–77 are complete on `main`; the attached `_v4_5` salvage pair is archived under `docs/legacy/` and is not active authority.
