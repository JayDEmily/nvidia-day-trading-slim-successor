...
Current active gate: **none — the financial-calendar runtime-integration pack is closed through Gate 93 on `main`**. Gates 80–87 are complete on `main` as closed corrective-reconstruction evidence; the V6 successor pack is closed through Gate 79 on `main`; Gates 88–90 are complete on `main` in the predecessor financial-calendar interstitial pack; the financial-calendar runtime-integration pack is the active post-Gate-90 authority; the attached `_v4_5` salvage pair remains archived under `docs/legacy/` and is not active authority.
...
8. Gates 46–50 are complete on `main`; Gates 51–55 are complete on `main`; Gates 56–58 are complete on `main`; Gates 59–79 are complete on `main`; Gates 80–87 are complete on `main`; Gates 88–90 are complete on `main`; Gates 91–93 are complete on `main`; no later active gate is declared in-repo yet.
