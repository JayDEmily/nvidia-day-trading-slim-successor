...
def test_gate201_control_surfaces_and_docs_are_coherent() -> None:
    ...
    assert payload["execution_status"] in {"gates_200_201_complete_gate_202_active_on_main", "gates_200_202_complete_gate_203_active_on_main", "gates_200_204_complete_gate_205_active_on_main", "target_repo_admitted_evidence_successor_pack_closed_through_gate_205_on_work_branch", "target_repo_admitted_evidence_successor_pack_closed_through_gate_205_on_main"}
    assert payload["active_gate"] in {"Gate 202", "Gate 203", "Gate 205", "none"}
    assert payload["completed_gate_ids"] in [["Gate 200", "Gate 201"], ["Gate 200", "Gate 201", "Gate 202"], ["Gate 200", "Gate 201", "Gate 202", "Gate 203", "Gate 204"], ["Gate 200", "Gate 201", "Gate 202", "Gate 203", "Gate 204", "Gate 205"]]
    ...
    assert any(marker in execution_log for marker in ["Gate 202 is now the active gate in this pack.", "Gate 203 is now the active gate in this pack.", "Gate 205 is now the active gate in this pack.", "no active pack is currently routed"])
    assert any(marker in checklist for marker in ["Gates 200-201 complete on `main`, Gate 202 active.", "Gates 200-202 complete on `main`, Gate 203 active.", "Gates 200-204 complete on `main`, Gate 205 active.", "through Gate 205 on `work/gate-205-successor-pack-closeout-handoff-20260406`", "through Gate 205 on `main`"])
