...
from nvda_desk.schemas.events import EventIngestionAuthorityPacket
...
class EventIngestionAuthorityResponse(BaseModel):
    """Future config/API hook for the frozen Gate 72 event-ingestion packet."""
