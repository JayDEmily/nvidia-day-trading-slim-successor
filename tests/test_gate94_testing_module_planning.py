...
def test_testing_module_pack_is_retained_as_predecessor_evidence() -> None:
    ...
    assert (
        "Current active gate: **Gate 111 in the repo-process governance pack**." in gate_map
        or "Current active gate: **Gate 112 in the repo-process governance pack**." in gate_map
        or "Current active gate: **none — repo-process governance pack closed through Gate 112 on `main`**." in gate_map
        or "Current active gate: **Gate 115 in the historical-evaluation readiness pack**." in gate_map
        or "Current active gate: **Gate 116 in the historical-evaluation readiness pack**." in gate_map
        or "Current active gate: **Gate 117 in the historical-evaluation readiness pack**." in gate_map
        or "Current active gate: **Gate 118 in the historical-evaluation readiness pack**." in gate_map
        or "Current active gate: **Gate 119 in the historical-evaluation readiness pack**." in gate_map
        or "Current active gate: **Gate 120 in the historical-evaluation readiness pack**." in gate_map
        or "Current active gate: **Gate 121 in the historical-evaluation readiness pack**." in gate_map
        or "Current active gate: **none — historical-evaluation readiness pack closed through Gate 121 on `main`**." in gate_map
