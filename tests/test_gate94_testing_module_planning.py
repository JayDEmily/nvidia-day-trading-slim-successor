...
def test_active_planning_surfaces_point_at_the_testing_module_pack() -> None:
    ...
    assert ("Current active gate: **Gate 95 in the testing-module pack**." in gate_map) or ("Current active gate: **Gate 96 in the testing-module pack**." in gate_map) or ("Current active gate: **Gate 97 in the testing-module pack**." in gate_map) or ("Current active gate: **Gate 98 in the testing-module pack**." in gate_map) or ("Current active gate: **Gate 99 in the testing-module pack**." in gate_map)
...
def test_testing_module_leaves_mark_gate94_complete_and_gate95_next() -> None:
    ...
    assert leaves["execution_status"] in {"gate_94_testing_module_pack_active_from_gate_95", "gate_95_testing_module_pack_active_from_gate_96", "gate_96_testing_module_pack_active_from_gate_97", "gate_97_testing_module_pack_active_from_gate_98", "gate_98_testing_module_pack_active_from_gate_99"}
    assert leaves["active_gate"] in {"Gate 95", "Gate 96", "Gate 97", "Gate 98", "Gate 99"}
...
def test_testing_module_execution_log_records_gate94_receipts() -> None:
    ...
    assert ("Status: active execution log for the testing-module pack; Gate 94 complete on `main`, Gate 95 next" in execution_log) or ("Status: active execution log for the testing-module pack; Gates 94-95 complete on `main`, Gate 96 next" in execution_log) or ("Status: active execution log for the testing-module pack; Gates 94-96 complete on `main`, Gate 97 next" in execution_log) or ("Status: active execution log for the testing-module pack; Gates 94-97 complete on `main`, Gate 98 next" in execution_log) or ("Status: active execution log for the testing-module pack; Gates 94-98 complete on `main`, Gate 99 next" in execution_log)
