...
def test_gate145_receipt_domain_model_and_vocabulary_are_present() -> None:
    ...
    assert leaves["active_gate"] in {"Gate 145", "Gate 146", "Gate 147", "Gate 148", "Gate 149", "none — stage-local handoff and terminal-risk seams pack closed through Gate 149 on main"}
