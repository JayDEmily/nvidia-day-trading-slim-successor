...
def test_gate200_pack_surfaces_are_coherent() -> None:
    ...
    assert any(marker in plans for marker in ["- next active gate: `Gate 200`", "- next active gate: `Gate 201`", "- next active gate: `Gate 202`", "- next active gate: `Gate 203`", "- next active gate: `Gate 204`", "- next active gate: `Gate 205`"])
    ...
    assert any(marker in gate_map for marker in ["Gate 205 | planned", "Gate 205 | active"])
    ...
    assert payload["execution_status"] in {"gate_200_active_on_work_branch", "gate_200_complete_gate_201_active_on_work_branch", "gates_200_201_complete_gate_202_active_on_main", "gates_200_202_complete_gate_203_active_on_main", "gates_200_204_complete_gate_205_active_on_main"}
    assert payload["active_gate"] in {"Gate 200", "Gate 201", "Gate 202", "Gate 203", "Gate 205"}
    assert payload["completed_gate_ids"] in [[], ["Gate 200"], ["Gate 200", "Gate 201"], ["Gate 200", "Gate 201", "Gate 202"], ["Gate 200", "Gate 201", "Gate 202", "Gate 203", "Gate 204"]]
    ...
    assert any(marker in execution_log for marker in ["Gate 200 remains the active gate", "Gate 200 is complete, and Gate 201 is now the active gate in this pack.", "Gate 202 is now the active gate in this pack.", "Gate 203 is now the active gate in this pack.", "Gate 205 is now the active gate in this pack."])
