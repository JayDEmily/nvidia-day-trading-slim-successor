...
def test_gate200_pack_surfaces_are_coherent() -> None:
    ...
    assert any(marker in plans for marker in ["- next active gate: `Gate 200`", "- next active gate: `Gate 201`", "- next active gate: `Gate 202`", "- next active gate: `Gate 203`", "- next active gate: `Gate 204`", "- next active gate: `Gate 205`", "- no active pack currently routed"])
    ...
    assert any(marker in gate_map for marker in [
        ...
        "Current active gate: **none — target-repo admitted-evidence successor planning pack closed through Gate 205 on `work/gate-205-successor-pack-closeout-handoff-20260406`**.",
        "Current active gate: **none — target-repo admitted-evidence successor planning pack closed through Gate 205 on `main`**.",
    ])
    ...
    assert any(marker in gate_map for marker in ["Gate 203 | active", "Gate 203 | planned", "Gate 203 | complete"])
    assert any(marker in gate_map for marker in ["Gate 204 | active", "Gate 204 | planned", "Gate 204 | complete"])
    assert any(marker in gate_map for marker in ["Gate 205 | planned", "Gate 205 | active", "Gate 205 | complete"])
    ...
    assert any(status in gates for status in [
        ...
        "Status: closed target-repo admitted-evidence successor planning pack through Gate 205 on `main`.",
    ])
    assert payload["execution_status"] in {"gate_200_active_on_work_branch", "gate_200_complete_gate_201_active_on_work_branch", "gates_200_201_complete_gate_202_active_on_main", "gates_200_202_complete_gate_203_active_on_main", "gates_200_204_complete_gate_205_active_on_main", "target_repo_admitted_evidence_successor_pack_closed_through_gate_205_on_work_branch", "target_repo_admitted_evidence_successor_pack_closed_through_gate_205_on_main"}
    assert payload["active_gate"] in {"Gate 200", "Gate 201", "Gate 202", "Gate 203", "Gate 205", "none"}
    assert payload["completed_gate_ids"] in [[], ["Gate 200"], ["Gate 200"], ["Gate 200", "Gate 201"], ["Gate 200", "Gate 201", "Gate 202"], ["Gate 200", "Gate 201", "Gate 202", "Gate 203", "Gate 204"], ["Gate 200", "Gate 201", "Gate 202", "Gate 203", "Gate 204", "Gate 205"]]
    assert payload["pending_gate_ids"] in [["Gate 200", "Gate 201", "Gate 202", "Gate 203", "Gate 204", "Gate 205"], ["Gate 201", "Gate 202", "Gate 203", "Gate 204", "Gate 205"], ["Gate 202", "Gate 203", "Gate 204", "Gate 205"], ["Gate 203", "Gate 204", "Gate 205"], ["Gate 205"], []]
    ...
    assert any(marker in execution_log for marker in ["Gate 200 remains the active gate", "Gate 200 is complete, and Gate 201 is now the active gate in this pack.", "Gate 202 is now the active gate in this pack.", "Gate 203 is now the active gate in this pack.", "Gate 205 is now the active gate in this pack.", "no active pack is currently routed"])
