...
GATES = (
    REPO_ROOT / "docs/planning/2026-03-26_COGNITIVE_WORKFLOW_MODIFICATION_GATES_v1.md"
)
LEAVES = (
    REPO_ROOT
...
IMPLEMENTATION_MAP = (
    REPO_ROOT / "docs/planning/2026-03-26_COGNITIVE_WORKFLOW_IMPLEMENTATION_MAP.md"
)
BOUNDARY_RULES = (
    REPO_ROOT / "docs/planning/2026-03-26_COGNITIVE_WORKFLOW_BOUNDARY_RULES.md"
)
...
GATE53 = (
    REPO_ROOT / "docs/planning/2026-03-26_GATE53_CARRY_WEEKEND_EVENT_FORMALISATION.md"
)
...
def test_gate51_outputs_pin_step0_and_candidate_boundaries() -> None:
    ...
    assert (
        "Carry-horizon decisioning is owned by the **carry branch**"
        in implementation_map
    )
