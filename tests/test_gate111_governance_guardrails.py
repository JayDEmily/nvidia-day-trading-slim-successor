...
def test_governance_trio_agrees_on_gate111_or_later() -> None:
    ...
    assert ("Current active gate: **Gate 111 in the repo-process governance pack**." in gate_map) or ("Current active gate: **Gate 112 in the repo-process governance pack**." in gate_map) or ("Current active gate: **none — repo-process governance pack closed through Gate 112 on `main`**." in gate_map) or ("Current active gate: **none — execution-authority microtranche closed through Gate 113 on `main`**." in gate_map) or ("Current active gate: **none — research-mode clarity microtranche closed through Gate 114 on `main`**." in gate_map)
    assert ("Status: active execution log for the repo-process governance pack; Gates 107-110 complete on `main`, Gate 111 next" in execution_log) or ("Status: active execution log for the repo-process governance pack; Gates 107-111 complete on `main`, Gate 112 next" in execution_log) or ("Status: closed execution log for the repo-process governance pack; Gates 107-112 complete on `main`, no active gate" in execution_log)
