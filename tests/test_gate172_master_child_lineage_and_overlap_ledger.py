...
def test_gate172_is_complete_and_pack_has_moved_to_gate176_or_later() -> None:
    ...
    assert "active gate: Gate 176 on `work/gate-171-master-child-parallel-risk-integration-pack-20260402`" in plans or "closed through Gate 180" in plans
    assert "Current active gate: **Gate 176 in the master/child parallel-risk integration pack**." in gate_map or "Current active gate: **none — master/child parallel-risk integration pack closed through Gate 180" in gate_map
