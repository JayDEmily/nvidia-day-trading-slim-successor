...
from nvda_desk.schemas.cognition import CapitalDeploymentAuthorityAction, CapitalDeploymentAuthorityInput
...
def _runtime_result(*, stressed: bool = False, vix_level: float | None = None, vvix_level: float | None = None):
